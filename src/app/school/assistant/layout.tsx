// ============================================================
// Garde serveur — /school/assistant et /school/assistant/history
// ============================================================
// Ces deux pages sont des composants CLIENT ("use client") : elles ne peuvent
...
export default async function SchoolAssistantLayout({
  children,
}: {
