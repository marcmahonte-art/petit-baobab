...
import { SCHOOL_SUPPORT_WHATSAPP } from "@/components/school/SchoolSupportButton"
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        <a
          href={`https://wa.me/22664556565?text=${encodeURIComponent("Bonjour Petit Baobab, je suis un compte école et j'ai besoin d'aide.")}`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 h-[44px] px-6 rounded-full bg-[#25D366] text-white text-sm font-bold hover:bg-[#1FB855] transition-colors"
        >
          ...
          WhatsApp {SCHOOL_SUPPORT_WHATSAPP}
        </a>
        <a
