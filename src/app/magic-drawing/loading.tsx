export default function MagicDrawingLoading() {
  return (
          ...
          <div className="animate-pulse space-y-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[1fr_420px] gap-6">
              <div className="space-y-5">
                <div className="h-[280px] bg-[#EFE7DB] rounded-[24px]" />
                <div className="h-[200px] bg-[#EFE7DB] rounded-[24px]" />
                <div className="h-[180px] bg-[#EFE7DB] rounded-[24px]" />
              </div>
              <div className="h-[400px] bg-[#EFE7DB] rounded-[24px]" />
            </div>
          </div>
        </main>
      </div>
