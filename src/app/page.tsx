      ...
      <header className="sticky top-0 z-50 bg-[#fef5e0]/90 backdrop-blur-sm border-b border-gray-100 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold">
            ...
            <a className="hover:text-[#6D4CFF] transition-colors" href="/boutique">Boutique</a>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="bg-background pt-16 w-[290px]">
                <nav className="flex flex-col gap-6 mt-8">
                  ...
                  <a href="/boutique" className="text-[15px] font-semibold text-[#1A1A2E] hover:text-[#6D4CFF] transition-colors">Boutique</a>
