...
export const statsCards: { key: keyof PortfolioStats; label: string; icon: string }[] = [
  { key: "drawings", label: "Dessins", icon: "/icons/marketing/dessins.png" },
  { key: "books", label: "Livres", icon: "/icons/marketing/livres.png" },
  { key: "colorings", label: "Coloriages", icon: "/icons/marketing/coloriages.png" },
  { key: "magicDrawings", label: "Dessins magiques", icon: "/icons/marketing/marqueur-ia.png" },
  { key: "stories", label: "Histoires", icon: "/icons/marketing/histoires.png" },
  { key: "quizzes", label: "Quiz", icon: "/icons/marketing/quiz.png" },
  { key: "games", label: "Jeux", icon: "/icons/marketing/jeux-educatifs.png" },
  { key: "badges", label: "Badges", icon: "/icons/marketing/badges.png" },
  { key: "rewards", label: "Récompenses", icon: "/icons/marketing/recompenses.png" },
  { key: "challenges", label: "Défis", icon: "/icons/marketing/defis.png" },
  { key: "certificates", label: "Certificats", icon: "/icons/marketing/certificats.png" },
  { key: "collections", label: "Collections", icon: "/icons/marketing/collections.png" },
  { key: "photos", label: "Photos souvenirs", icon: "/icons/marketing/photos-de-souvenirs.png" },
]
