...
export default function StarsBalanceWidget({
  ...
  return (
    <div className="bg-[#FFFDF8] rounded-2xl p-5 shadow-sm border border-[#F0E7DA]">
      ...
      <button className="mt-4 w-full h-11 bg-[#7D6AF8] hover:bg-[#6552E8] active:translate-y-0.5 text-white font-bold text-sm rounded-xl transition-all cursor-pointer shadow-sm shadow-[#7D6AF8]/20">
        Acheter des étoiles
      </button>
    </div>
  );
