...
export default function QuickActionsWidget() {
  ...
  const actions = [
    { label: "Créer une activité", icon: Palette, color: "#7D6AF8", href: null },
    { label: "Ajouter un élève", icon: UserPlus, color: "#EC4899", href: "/school/students/add" },
    { label: "Gérer les étoiles", icon: Star, color: "#F59E0B", href: "/school/etoiles" },
    { label: "Voir les rapports", icon: BarChart3, color: "#3B82F6", href: "/school/progression" },
  ];
