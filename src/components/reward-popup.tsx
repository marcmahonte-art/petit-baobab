      ...
      {isRewardPopupOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative bg-white rounded-[24px] md:rounded-[32px] border-4 border-[#FFD95C] p-5 md:p-8 w-full max-w-[380px] md:max-w-[420px] text-center shadow-xl select-none overflow-hidden z-10"
          >
            ...
            <div className="mx-auto w-[80px] h-[80px] md:w-[120px] md:h-[120px] rounded-full bg-gradient-to-tr from-[#FFE08A] to-[#FFD95C] flex items-center justify-center shadow-md relative mb-4 md:mb-6">
              <Award className="w-10 h-10 md:w-16 md:h-16 text-[#3B2416]" />
              <motion.div
                animate={{ rotate: 360 }}
            ...
            {/* Title */}
            <h2 className="text-xl md:text-3xl font-extrabold text-[#2D1846] flex items-center justify-center gap-1.5 leading-tight">
              <Star className="w-5 h-5 md:w-7 md:h-7 text-[#FFB300] fill-current" /> Bravo Awa !
            </h2>
            <p className="text-[#7A6A5E] text-sm md:text-base font-bold mt-1 md:mt-2 leading-tight">
              Ton coloriage est magnifique !
            </p>

            {/* Reward Info */}
            <div className="my-4 md:my-6 grid grid-cols-2 gap-3 md:gap-4">
              <div className="bg-[#FFE08A]/35 border border-[#FFE08A] rounded-[16px] md:rounded-[20px] p-3 md:p-4 flex flex-col items-center justify-center">
                <span className="text-lg md:text-2xl font-black text-[#3B2416]">+10</span>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => setRewardPopupOpen(false)}
              className="w-full h-[46px] md:h-[52px] rounded-full bg-[#20C997] hover:bg-[#20C997]/90 text-white font-extrabold text-sm md:text-base shadow-md cursor-pointer border-none flex items-center justify-center gap-2"
            >
