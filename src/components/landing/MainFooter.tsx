        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 justify-center md:justify-start">
              ...
              {/* Instagram */}
              <a className="w-9 h-9 bg-white rounded-full flex items-center justify-center text-pink-600 hover:scale-110 transition-transform border border-gray-100 shadow-sm" href="https://www.instagram.com/petit.baobab1?igsh=NjZvZjZjYzhkbjlm" target="_blank" rel="noopener noreferrer">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
